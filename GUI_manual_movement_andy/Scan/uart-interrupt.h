...
extern volatile char received_char; // byte value for special character used as a command
...
// Get the char that was received by the uart, char 0 if nothing has been received
char get_char(void);

// Reset the char that was received by the uart
